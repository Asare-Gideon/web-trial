...
import { AddUaeTypes } from "@/components/ui/AddUaeTypes";
...
const Page = () => {
  ...
  return (
    <div className="p-4">
      <TitleComp title="Add New Made in UAE" />
      <div className="mt-5">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <div className=" lg:flex gap-5">
              ...
              <div className="lg:w-[50%] flex flex-col ">
                <div>
                  <h3 className="text-md">Add UAE Cover Image</h3>
                  <div className="mt-4">
      ...
      <AddUaeTypes open={openBlogTypeModal} close={handleCloseBlogtypeModal} />
      <AlertComp
