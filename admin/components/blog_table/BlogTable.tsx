...
const blogImg = require("../../public/images/bg-img/blog.jpg");
  ...
  return (
    <div>
        ...
        rows={blogs
          ...
          .map((blog) => ({
            ...
            list: [
              ...
              { data: truncate(blog.blogData.title, 10) },
      ...
      <AlertComp
        ...
        title="Set blog visibility"
        message="Are you sure you want to update the visibility of this blog?"
        id={deleteSelected}
        onOk={async () => {
          if (blobPublishDate === null) {
            await updateDoc(doc(FIREBASE_DB, "blogs", deleteSelected), {
      ...
      />
      <AlertComp
        message="Are sure you want to delete this blog?"
