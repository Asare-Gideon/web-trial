  ...
  const handleAddOrder = async () => {
    ...
    handleAddProductCaller(async () => {
      await addDoc(collection(FIREBASE_DB, "orders"), {
        ...
        delivered: false,
        deliveredOn: null,
        products: orderItm.products,
        orderTotalPrice: orderItm.orderTotalPrice,
        user: {
          name: orderItm.user.name,
          email: orderItm.user.email,
          phone: orderItm.user.phone,
          postOffice: orderItm.user.postOffice,
          address: orderItm.user.address,
          anotherAddress: orderItm.user.anotherAddress,
        },
      });
    });
    localStorage.clear();
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          user: {
            ...
            address: address,
            anotherAddress: diffAddr ? shippingAddress : null,
          },
        })
      );
      setPaymentLoading(true);
