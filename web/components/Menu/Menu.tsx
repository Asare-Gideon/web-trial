...
export default function Menu({ scrolled }: { scrolled: boolean }) {
              ...
              >
                ...
                <div className="mb-10">
                  <div className="itemContainer px-6 w-full flex flex-col justify-around items-center">
                    ...
                    <div className="w-full text-xl py-2 my-3 flex justify-between"></div>
                    <hr className="border border-gray300 w-full" />
                    <Link href="/wishlist">
                      <span className="text-xl py-2 my-3 w-full flex justify-between">
                        <span>wishlist</span>
