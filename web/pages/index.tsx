...
const Home: React.FC<Props> = ({ products }) => {
  ...
  const { items, isLoading, isStart, isEnd, getPrev, getNext } =
    usePagination<ProductType>(
      query(collection(FIREBASE_DB, "courses"), where("visible", "==", true)),
      {
        limit: 4,
      }
    );
      ...
      <main id="main-content" className="-mt-20">
              ...
              <div>
                ...
                >
                  <div className="section-title">
                    ...
                    <h3 className="font-Cormorant">Making learning exciting</h3>
                  </div>
                  <div className="section-content">
                    <p className="mb-8">E Learning platform.</p>
                    <Link
        ...
        <section className="app-max-width w-full h-full flex flex-col justify-center mt-16 mb-20">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 lg:gap-x-12 gap-y-20 mb-10 app-x-padding">
              {items.map((item) => (
